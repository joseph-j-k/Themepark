...
<html lang="en" >
    ...
    <body>
        ...
        <a href="Dashboard.php" class="search">Back</a>
        <br><br>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_booking b inner join tbl_package p on p.package_id = b.package_id inner join tbl_user u on u.user_id = b.user_id inner join tbl_park pa on pa.park_id = p.park_id where true and booking_status > 0";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["park_name"]; ?></td>
                 <td align="center"><?php echo $data["user_name"]; ?></td>
                 <td align="center"><?php echo $data["package_name"]; ?></td>
                 <td align="center"><?php echo $data["package_price"]; ?></td>
              </tr>
               <?php
				}
			?>
