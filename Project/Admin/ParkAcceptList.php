...
<form id="form1" name="form1" method="post" action="">
  <table>
    ...
    <?php
	$i=0; 
	$sel = "select * from tbl_park pa inner join tbl_place p on p.place_id = pa.place_id inner join tbl_district d on d.district_id = p.district_id where park_status = '1' ";
    ...
    <tr>
      ...
      <td>
      <a href="ParkAcceptList.php?reject=<?php echo $data['park_id'] ?>">Reject</a>
      </td>
    </tr>
    <?php } ?>
  </table>
